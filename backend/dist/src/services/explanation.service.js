...
import { stepsResponse, hintResponse, explanationResponse } from "../schemas/explanation.schema";
import * as z from 'zod';
export async function generateSteps(data) {
...
export async function generateStepExplanation(data) {
    const prompt = `
